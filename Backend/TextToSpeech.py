...
def TTS(Text, func=lambda r=None: True):
    while True:
        try:
            ...
            return True   # Return True if the audio played successfull
            ...
            try:
                # Call th provided function with False to signal the end of TTS
                func(False)
                pygame.mixer.music.stop()   # Stop the autio playback
...
def TextToSpeech(Text, func=lambda r=None: True):
    Data = str(Text).split(".")   # Spliy the text by periods into a list of sentences
